...
const navItems = [
  { id: "accueil", label: "Accueil", to: "/", lordicon: LORD_ICONS.home },
  { id: "licence", label: "Licence", to: "/licence", lordicon: LORD_ICONS.book },
  { id: "master", label: "Master", to: "/master", lordicon: LORD_ICONS.trophy },
  { id: "cv", label: "CV", to: "/cv", lordicon: LORD_ICONS.avatar },
];
